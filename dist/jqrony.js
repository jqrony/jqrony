/*!
 * jQrony v1.0.0
 * jQrony is pure Javascript Library v1.0.0
 * 
 * Copyright OpenJS Foundation and other contributors
 * Released under the MIT license
 * 
 * Author: Shahzada Modassir <codingmodassir@gmail.com>
 * Date: 01-11-2022 AT 02:10 PM
 */
...
if ( window.localStorage.getItem && !window.localStorage.getItem("jqrony") ) {
   var msg = "jQrony v1.0.0 active on your Browser.";
...
jQrony.fn = jQrony.prototype = {
   ...
   // The current version of jQrony being use Latest: v1.0.0
   version: version,
...
var Snizzle =
/*!
 * Snizzle CSS Selector Engine v1.0.0
 * 
...
// SET: current version of Snizzle v1.0.0
...
jQrony( document ).on( "DOMContentLoaded", function() {
   ...
   ( function() {
      ...
      jQrony( "img" ).each( function() {
         ...
         if ( !this.alt ) {
            jQrony( this ).attr( "alt", alt || "( Coding Modassir )" );
         }
      } );
